...
const DEEPL_API_KEY = "346e7765-1544-4824-b102-ab2c6a97195a:fx";
let language = "cs";
...
const changeLanguageFunc = async () => {
  if (language === "cs") {
    jokeElement.textContent = await translateText(jokeElement.textContent, "EN");
    language = "en";
    changeLanguage.textContent = "ZMĚNIT JAZYK";
    nextJokeBtn.textContent = "NEXT JOKE";
  }
  else {
    jokeElement.textContent = await translateText(jokeElement.textContent, "CS");
    language = "cs";
